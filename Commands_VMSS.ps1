...
$settings = @{
  "fileUris" = (," ~/create-webserver-and-deploy-app.ps1");# add ur powershell script path either from your local machine or from u r container
...
# ay a frontend and backend IP pool
